...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://openrouter.ai https://api.stripe.com https://fonts.gstatic.com https://fonts.googleapis.com https://app.cal.com https://api.dicebear.com",
      "frame-src 'self' https://checkout.stripe.com https://app.cal.com",
      "media-src 'self' blob:",
