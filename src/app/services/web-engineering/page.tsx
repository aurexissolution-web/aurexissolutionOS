...
export const metadata: Metadata = {
  title: "Custom Web Development Malaysia — Aurexis",
  description:
    "Performance-first websites, e-commerce, and customer portals for Malaysian businesses. Lighthouse 90+ default. RM 15-50k.",
};

export default function WebEngineeringPage() {
  const pillar = PILLARS["web-engineering"];
