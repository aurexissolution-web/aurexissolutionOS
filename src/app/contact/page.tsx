...
const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
        <path d="M13.5 22v-8.25h2.75l.5-3.25H13.5V8.5c0-.94.312-1.75 1.75-1.75H17V3.875C16.75 3.844 15.75 3.75 14.625 3.75c-2.687 0-4.5 1.625-4.5 4.625v2.375H7.25v3.25h2.875V22z" />
      </svg>
    ),
  },
  {
  ...
  {
    label: "X (Twitter)",
    href: "https://x.com/aurexissolution?s=21",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
